// Exercicio Quadrante GicellyGomes
 int coordinate1, coordinate2;

    Console.Clear();
    Console.WriteLine("*--- Sejam Bem Vindos ao Quadrante Cartesiano ---* ");
    Console.ResetColor();

    Console.WriteLine("Aonde encontrar a coordenada X? ");
    coordinate1 = int.Parse(Console.ReadLine()!);
      
    Console.WriteLine("Aonde encontrar a coordenada Y? ");
